...
public class ArticleDetailActivity extends AppCompatActivity
  ...
  private int marginColor = 0x22000000;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mPager.setPageMarginDrawable(new ColorDrawable(marginColor));
    mPager.addOnPageChangeListener(mSimplePageChangeListner);
  ...
  ViewPager.SimpleOnPageChangeListener mSimplePageChangeListner =
  ...
  @Override protected void onDestroy() {
    super.onDestroy();
    mPager.removeOnPageChangeListener(mSimplePageChangeListner);
  }
}
